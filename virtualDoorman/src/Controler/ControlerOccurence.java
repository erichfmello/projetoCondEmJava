...
public class ControlerOccurence extends ControlerConection {
	...
	// Update
	public void updateOccurence(String cnpj, Date occurenceDate, String description, int appartament) {
		DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
		...
		try {
			...
			JOptionPane.showMessageDialog(null, df.format(occurenceDate));
			JOptionPane.showMessageDialog(null, description);
			JOptionPane.showMessageDialog(null, appartament);
			
			comandSql.executeUpdate("update livroNegro set dataOcorrencia = '" + df.format(occurenceDate) + "' where cnpj = '" + cnpj + "' and apartamento = " + appartament);
			comandSql.executeUpdate("update livroNegro set descricao = '" + description + "' where cnpj = '" + cnpj + "' and apartamento = " + appartament);
