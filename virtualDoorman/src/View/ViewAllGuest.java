...
public class ViewAllGuest {
	...
	private void removeGuest() {
		int controler = listAllGuests.getSelectedIndex();
		documentGuest = controlerAllGuest.getModelGuests()[controler].getDocumentGuest();
		
		controlerAllGuest.deleteGuest(documentGuest);
	}
}
