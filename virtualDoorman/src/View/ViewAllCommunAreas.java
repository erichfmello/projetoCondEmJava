...
public class ViewAllCommunAreas {
	...
	private void initialize() {
		...
		frmAllAreas.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Erich\\Faculdade\\ProjetoCondominio\\img\\areasComunsR2.png"));
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
				viewCommonAreas = new ViewCommonAreas(cnpj, listAllAreas.getSelectedValue().toString());
				viewCommonAreas.frmCommunAreas.setVisible(true);
			}
		});
